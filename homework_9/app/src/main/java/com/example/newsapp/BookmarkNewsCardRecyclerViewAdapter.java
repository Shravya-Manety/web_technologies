...
public class BookmarkNewsCardRecyclerViewAdapter extends RecyclerView.Adapter<BookmarkNewsCardRecyclerViewAdapter.BookmarkNewsCardViewHolder> {
    ...
    public BookmarkNewsCardRecyclerViewAdapter(List<JSONObject> items, ClickListener clickListener) {
    ...
    public class BookmarkNewsCardViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public BookmarkNewsCardViewHolder(View view, BookmarkNewsCardRecyclerViewAdapter adapter, ClickListener clickListener) {
            super(view);
        ...
        private void removeArticleFromBookmarkSharedPref(JSONObject clickedArticle) throws JSONException {
        ...
        public void onClick(View v) {
            ...
            try {
                if(v.getId() == bookmarkNewsCardImageView.getId()){
                    ...
                    removeArticleFromBookmarkSharedPref(clickedNewsCardObj);
                }
                else{
            ...
            clickListenerWeakRef.get().onPositionClicked(getAdapterPosition());
        }
        ...
        public boolean onLongClick(View v) {
            ...
            if(v.getId() == bookmarkNewsCardImageView.getId()){
                ...
                ImageView alertDialogImageView = (ImageView) dialog.findViewById(R.id.alert_dialog_image);
                TextView alertDialogTitle = (TextView) dialog.findViewById(R.id.alert_dialog_title);
