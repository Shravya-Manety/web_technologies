...
public class TechnologyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bundle.putString("newsUrl", "http://localhost:5000/guardianTech");
        bundle.putString("parent", "MainActivity");
        newsCardFragment.setArguments(bundle);
        MainActivity.fragmentManager.beginTransaction().add(R.id.technology_fragment, newsCardFragment, null).commit();

        swipeToRefresh = view.findViewById(R.id.news_swipeRefresh_technology);
